...
Un actor es una representación de una persona, proceso o entidad externa que interactúa con el sistema. Se van a considerar los siguientes tipos de actores:
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Usuario registrado en el sistema con control completo sobre la aplicación.
            \item Tiene competencias exclusivas para la gestión de usuarios, importación de guardias, configuración de tarifas, cierre y reapertura de meses, generación de documentos y auditoría.
        \end{itemize}

        \item \textbf{Usuario de consulta}
        \begin{itemize}
            \item Usuario registrado con permisos limitados.
            \item Puede consultar información relacionada con guardias, vistas diaria y mensual, búsquedas y resúmenes de horas e importes, sin capacidad de modificación.
        \end{itemize}
    \end{itemize}
...
\section{Casos de uso}
  ...
  Los casos de uso describen las acciones que pueden desarrollar los actores del sistema. Se ha identificado los siguientes casos de uso principales, que son descritos en las secciones que se indican:
    \begin{itemize}
        ...
        \item \textbf{CU-1. Consultar información de guardias} (Sección \ref{sec:CU-1})
        \item \textbf{CU-2. Administrar sistema de guardias}(Sección \ref{sec:CU-2})
    \end{itemize}
...
\subsection{CU-1. Consultar información de guardias}\label{sec:CU-1}

El caso de uso \textit{CU-1. Consultar información de guardias} describe las acciones que puede realizar un usuario de consulta o un administrador para visualizar información del sistema.

Este caso de uso está compuesto por los siguientes subcasos:
\begin{itemize}
    \item CU-1.1. Consultar guardias por mes y especialidad.
    \item CU-1.2. Consultar guardias de un profesional.
    \item CU-1.3. Visualizar vista diaria de guardias.
\end{itemize}
...
\end{figure}
    ...
    \begin{table}[H]
    \caption{CU-1. Consultar información de guardias}\label{tab:CU-1}
        \begin{center}
            \begin{tabular}{|l|p{12cm}|}
            \hline
            \multicolumn{2}{|c|}{Caso de uso 1 - Consultar información de guardias} \\ 
            \hline \hline
            Actores & Usuario de consulta, Administrador \\ \hline
            Descripción & Consulta de información relacionada con las guardias \\ \hline
            Precondiciones & El usuario debe estar autenticado en el sistema \\ \hline
            Casos de uso & CU-1.1, CU-1.2, CU-1.3 \\ \hline
            Flujo principal & 
            1. El usuario selecciona una opción de consulta. \\
            & 2. El sistema solicita los datos al backend. \\
            & 3. El sistema muestra la información solicitada. \\ \hline
            Flujo alternativo & 
            1. Error en la obtención de datos. \\
            & 2. El sistema informa del error al usuario. \\ \hline
            \end{tabular}
        \end{center}
    \end{table}
