...
\begin{figure}[H]
\centering
%\includegraphics[scale=0.75]{img/diagramas/Datos/FNBC-Trabajador.png}
...
\begin{figure}[H]
\centering
%\includegraphics[scale=0.75]{img/diagramas/Datos/FNBC-Especialidad.png}
...
\begin{figure}[H]
\centering
%\includegraphics[scale=0.75]{img/diagramas/Datos/FNBC-Guardia.png}
