...
Se desea implementar una aplicación web que permita realizar una gestión más automatizada de las guardias mencionadas, reduciendo la dependencia del factor humano y minimizando los errores derivados de la gestión manual.
...
\item \textbf{Administrador}
    \begin{itemize}
    \item Este tipo de usuario estará registrado en el sistema y dispondrá de credenciales de acceso.
    \item Tendrá competencias exclusivas para la gestión de usuarios, creación y modificación de guardias, asignación de turnos y generación de informes.
    \end{itemize}

\item \textbf{Usuario estándar}
    \begin{itemize}
        \item Podrá consultar sus guardias asignadas, horas trabajadas y días libres.
        \item No tendrá permisos para modificar información crítica del sistema.
    \end{itemize}
\end{itemize}
...
\subsection{Vida esperada}
    ...
    El ciclo de vida esperado de la aplicación web será alto, ya que se ha diseñado con una arquitectura modular y escalable que permite su adaptación a futuras necesidades del hospital, como la inclusión de nuevos tipos de usuarios o funcionalidades adicionales.
...
En la actualidad existen soluciones comerciales para la gestión de turnos y guardias. Sin embargo, muchas de ellas son genéricas, de coste inadecuado o no se adaptan completamente a las necesidades específicas del hospital de Pozoblanco. El presente proyecto se plantea como una solución personalizada y ajustada a dicho contexto.
...
Al desarrollar la aplicación web se tendrán en cuenta aspectos de seguridad fundamentales, entre ellos:
