...
\subsection{Funcionamiento}
    ...
    \item \textbf{Administrador}
        \begin{itemize}
        \item Usuario con acceso completo a las funcionalidades de gestión global.
        \item Responsable de la gestión de usuarios, carga de datos maestros y supervisión general.
        \end{itemize}

    \item \textbf{Jefe de Especialidad}
        \begin{itemize}
            \item Usuario responsable de un área concreta (especialidad).
            \item Encargado de validar y aprobar definitivamente los intercambios de guardia propuestos por sus trabajadores.
        \end{itemize}

    \item \textbf{Trabajador / Usuario de consulta}
        \begin{itemize}
            \item Profesional sanitario que utiliza la aplicación para consultar su cuadrante.
            \item Puede realizar fichajes geolocalizados e iniciar solicitudes de intercambio mutuo.
        \end{itemize}
    \end{itemize}
\subsection{Entorno}
...
\begin{itemize}
\item Se desarrollará una interfaz totalmente responsiva, intuitiva y amigable. El Capítulo \ref{cap:diseno-interfaz} describirá el diseño de la interfaz de la aplicación web.
\end{itemize}
