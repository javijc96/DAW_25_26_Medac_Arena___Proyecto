...
\subsection{Funcionamiento}
    Se desea implementar una aplicación web que permita realizar una gestión de servicios de suscripcion para alquilar material
    de gimnasia ofreciendo precios competentes que permitan el acceso a cualquier individuo 
