...
\begin{itemize}
    ...
    \item {\color{medac:medio}{ Javier Juárez Canals }}
    \item {\color{medac:medio}{ Raul Henares Palacios}}
    \item {\color{medac:medio}{ Antonio Moyano Garcia}}
    \item {\color{medac:medio}{ Jose Ramón Rejano Ruge }}
\end{itemize}
...
\pagecolor{white}
\normalsize{}
“La mayoría de los errores médicos son consecuencia de sistemas defectuosos, no de personas defectuosas.”
[Lucian Leape, Pionero mundial en seguridad del paciente.] (1930 – 2025)
\cleardoublepage
...
\part{Presentación}
\input{capítulos/01_Introducción.tex}
\input{capítulos/02_Objetivos.tex}
\input{capítulos/03_Recursos.tex}

\part{Contextualización empresarial}
\input{capítulos/04_Contextualización_Empresarial.tex}

\part{Análisis}
\input{capítulos/05_Especificación_Requisitos.tex}
\input{capítulos/06_Modelo_de_datos}
\input{capítulos/07_Análisis_Funcional}

\part{Diseño}
\input{capítulos/08_Diseno_de_datos.tex}
\input{capítulos/09_Diseno_arquitectonico.tex}
\input{capítulos/10_Diseno_de_la_interfaz}

\part{Pruebas}
\input{capítulos/11_Pruebas}

\part{Conclusiones y futuras mejoras}
\input{capítulos/12_Conclusiones}
\input{capítulos/13_Futuras_mejoras}

\input{capítulos/20_Anexos.tex}
